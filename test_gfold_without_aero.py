...
def solve_gfold(vessel):
    ...
    params.solver.n = 100
    params.solver.time_of_flight = 30
...
while True:
    ...
    throttle = (norm(target_direction) * mass / available_thrust) + compensation
    ...
    vessel.update_ap(target_direction)
    print(f"throttle: {throttle}, landing time: {landing_time}, estimated impact speed: {estimated_impact_speed}, com: {compensation}")
